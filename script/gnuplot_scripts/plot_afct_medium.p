# Gnuplot script file for plotting data in file "afct_medium_avg.txt"
...
#  set xr [0.2:0.8]
	 # set yr [0.0:0.12]
      datafile = "../results/afct_medium_avg.txt"
