# Gnuplot script file for plotting data in file "rexpkts_avg.txt"
...
#set style histogram cluster gap 1
	 ...
	 set ytic auto                          # set ytics automatically
      set xlabel "Load"
      set ylabel "Packets Retransmitted"
      set key left top
	 # set label "Yield Point" at 0.003,260 
	 # set arrow from 0.0028,250 to 0.003,280
#  set xr [0.2:0.8]
	 # set yr [0.0:0.12]
	    datafile = "../results/rexpkts_avg.txt"
