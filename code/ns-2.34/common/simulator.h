...
public:
	...
	void check(int n);
	// SMI 24-June-2017
	void initializeIncomingTrafficPerLeaf(); // initialize the incomingTrafficPerLeaf matrix
	void updateIncomingTrafficMatrix(int src_leaf, int dest_leaf, int change); // Update the statistics for a particular src leaf and dest leaf pair
	int getIncomingTrafficToLeaf(int src_leaf, int dest_leaf); // Return count for a specific src leaf and dest leaf pair
private:
	...
	int** incomingTrafficPerLeaf; // SMI 24-June-2017
	int numLeafs_; // SMI 24-June-2017
};
